...
-   If you open a pull request, you must sign the
    [Individual Contributor License Agreement](https://github.com/lets-fiware/fiware-pi/blob/master/ngsi-go-individual-cla.pdf) by
...
If you'd like to contribute, start by searching through the [issues](https://github.com/lets-fiware/fiware-pi/issues) and
[pull requests](https://github.com/lets-fiware/fiware-pi/pulls) to see whether someone else has raised a similar idea or
question.
...
[Issues](https://github.com/lets-fiware/fiware-pi/issues) and [Pull Requests](https://github.com/lets-fiware/fiware-pi/pulls)
